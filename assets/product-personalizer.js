  ...
  const ICON_LIBRARY = [
    ...
    { name: 'Flor', className: 'zmdi-flower-alt' },
        { name: 'Ojo', className: 'zmdi-eye' },
            { name: 'Sonrisa', className: 'zmdi-mood' },
    { name: 'Bicicleta', className: 'zmdi-bike' },
    { name: 'Maleta', className: 'zmdi-case' },
    ...
    { name: 'Huella', svg: '<svg x="0px" y="0px" viewBox="0 0 12 12" style="enable-background:new 0 0 12 12;" xml:space="preserve"> <g> <ellipse transform="matrix(0.9691 -0.2468 0.2468 0.9691 -1.0083 2.2133)" cx="8.33" cy="5.13" rx="3.11" ry="4.16"/> <ellipse transform="matrix(0.9444 -0.3288 0.3288 0.9444 -3.5416 1.8178)" cx="3.6" cy="11.38" rx="3.11" ry="3.95"/> <ellipse transform="matrix(0.2785 -0.9604 0.9604 0.2785 3.92 27.9786)" cx="20.58" cy="11.38" rx="3.95" ry="3.11"/> <ellipse transform="matrix(0.1867 -0.9824 0.9824 0.1867 8.0347 19.9628)" cx="16.07" cy="5.13" rx="4.16" ry="3.11"/> <path d="M12.1,12.07c2.74-0.37,7.01,3.81,7.71,6.4s0.27,3.03-0.44,3.54c-0.71,0.51-2.26,0.51-3.91,0S13.11,21,12.1,21.1s-2.86,0.74-3.4,0.91c-0.54,0.17-2.59,1.01-4.08-0.24c-1.48-1.25,0.47-4.65,1.68-6.03S9.37,12.44,12.1,12.07z"/> </g> </svg>' },
    { name: 'Música', className: 'zmdi-collection-music' },
    { name: 'Luna', fallback: 'MO' },
