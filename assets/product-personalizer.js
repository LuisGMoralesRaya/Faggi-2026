  ...
  class ProductPersonalizer {
    ...
    renderTokenField(options) {
      return [
        ...
        '<span class="pp-token-field__count">Caracteres:</span><span class="pp-token-field__count" data-token-count="' + options.fieldKey + '"> 0 / '+ '<span class="pp-token-field__count">Max:</span>' + options.max + '</span>',
        '</div>',
