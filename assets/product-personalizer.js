  ...
  class ProductPersonalizer {
    ...
    renderSideTextSection(prefix, config, title) {
      ...
      const sections = [
        ...
        '<p class="pp-section__description">Elige tu tipo de letra y agrega iconos <span style="font-style: italic;">(cada icono cuenta como un caracter). Máx. 40 caracteres</span></p>',
        '</div>',
    ...
    renderCharmsSection() {
      return [
        ...
        '<div><button type="button" class="pp-slider-button" data-action="scroll-charms" data-direction="prev" aria-label="Ver charms anteriores">&larr;</button> <button type="button" class="pp-slider-button" style="float: right;" data-action="scroll-charms" data-direction="next" aria-label="Ver más charms">&rarr;</button></div>',
    ...
    renderFontPicker(fieldKey) {
      return [
        ...
        '<p class="pp-font-picker__label" style="margin-top:10px;">Tipo de letra:</p>',
