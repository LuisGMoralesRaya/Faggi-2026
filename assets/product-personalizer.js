(function () {
  ...
  const ICON_LIBRARY = [
    ...
    { name: 'Luna', svg: '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 12 12" style="enable-background:new 0 0 12 12;" xml:space="preserve"><style type="text/css">.st0{fill:#DE4F87;}</style><path class="st0" d="M5.64,0c0,0-2.47,3.24-0.44,6.48s6.44,2.27,6.44,2.27s-1.63,3.88-6.5,3.16c-4.88-0.72-5.44-5.94-4.6-8.1 S3.95,0,5.64,0z"/></svg>' },
