(function () {
  ...
  const ICON_LIBRARY = [
    ...
    { name: 'Huella', svg: '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 15.68 15.68" style="enable-background:new 0 0 15.68 15.68;" xml:space="preserve"><style type="text/css">.st0{fill:#DE4F87;}</style><g><ellipse transform="matrix(0.9691 -0.2468 0.2468 0.9691 -0.6902 1.5285)" class="st0" cx="5.75" cy="3.52" rx="1.86" ry="2.49"/><ellipse transform="matrix(0.9444 -0.3288 0.3288 0.9444 -2.2248 1.3656)" class="st0" cx="2.93" cy="7.26" rx="1.86" ry="2.37"/><ellipse transform="matrix(0.2785 -0.9604 0.9604 0.2785 2.472 17.812)" class="st0" cx="13.09" cy="7.26" rx="2.37" ry="1.86"/><ellipse transform="matrix(0.1867 -0.9824 0.9824 0.1867 4.9965 13.0701)" class="st0" cx="10.39" cy="3.52" rx="2.49" ry="1.86"/><path class="st0" d="M8.01,7.67c1.64-0.22,4.2,2.28,4.62,3.83s0.16,1.82-0.26,2.12s-1.35,0.3-2.34,0s-1.41-0.61-2.02-0.54c-0.61,0.06-1.71,0.44-2.04,0.54c-0.32,0.1-1.55,0.61-2.44-0.14s0.28-2.78,1.01-3.61S6.38,7.9,8.01,7.67z"/></g></svg>' },
